...
var forbidden_string_validators_1 = require('../../shared/validation/forbidden-string.validators');
var BugDetailComponent = (function () {
    function BugDetailComponent(formB, bugService) {
        this.formB = formB;
        this.bugService = bugService;
        this.modalId = "bugModal";
        this.statuses = constant_1.STATUS;
        this.severities = constant_1.SEVERITY;
        this.statusArr = [];
        this.severityArr = [];
    ...
    BugDetailComponent.prototype.configureForm = function (bug) {
        ...
        this.bugForm = this.formB.group({
            title: [this.currentBug.title, [forms_1.Validators.required, forbidden_string_validators_1.forbiddenStringValidator(/puppy/i)]],
